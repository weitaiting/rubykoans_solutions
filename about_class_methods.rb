...
class AboutClassMethods < Neo::Koan
  ...
  # I prefer the first way because it seems the most visually intuitive - the
  # << symbol in class << self seems potentially quite cryptic.
  # (Also because it resembles Python more.)
  # ------------------------------------------------------------------
