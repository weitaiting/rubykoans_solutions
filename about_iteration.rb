...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # My answer:
    # Inject initializes the value of the first variable (the accumulator) 
    # in the || brackets with the value specified in () brackets. 
    # Then it performs the step in the {} parentheses for each item 
    # in the array, altering the accumulator with every step. It returns
    # the value in the accumulator after all items in the array are exhausted.
  end
